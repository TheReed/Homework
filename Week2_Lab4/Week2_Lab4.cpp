 ...
 * 
 * Description: Change the BinarySearchTree.print member function to print the
 *              tree as a tree shape. It is easier to print the tree sideways.
 *              Extra credit if you instead print the tree with the root node
 *              centered on the top.
 */

#define HEAD "CIS328 Week 2 Lab 4 - Reed J. Williams"
...
public:
	void
	insert_node(TreeNode* new_node);
	void
	print_nodes() const;
	bool
	find(string value) const;
private:
	string data;
	TreeNode* left;
	TreeNode* right;
